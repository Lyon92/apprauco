...
<html lang="en">
  <head>
      ...
      <link href="<?php echo base_url() ?>public/css/datos.css" rel="stylesheet">
       ...
       <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Castaño</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php base_url()?>Login/logout"><i class="fa fa-sign-out fa-fw"></i> Salir</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php base_url() ?>dashboard"><i class="fa fa-dashboard fa-fw pull-right"></i> Dashboard</a>
                        </li>
                         <li>
                            <a href="<?php base_url() ?>usuarios"><i class="fa fa-users pull-right" aria-hidden="true"></i> Usuarios</a>
                        </li>
                       
                        <li>
                            <a href="<?php base_url() ?>tiendas"><i class="fa fa-cubes pull-right" aria-hidden="true"></i> Tiendas</a>
                        </li>
                        <li>
                            <a href="<?php base_url() ?>rutas"><i class="fa fa-truck pull-right" aria-hidden="true"></i> Rutas</a>
                        </li>
                         <li>
                            <a href="<?php base_url() ?>empresas"><i class="fa fa-building pull-right" aria-hidden="true"></i> Empresas</a>
                        </li>
                         <li>
                            <a href="<?php base_url() ?>perfiles"><i class="fa fa-child pull-right" aria-hidden="true"></i> Perfiles</a>
                        </li>
                         <li>
                            <a href="<?php base_url() ?>credenciales"><i class="fa fa-clone pull-right" aria-hidden="true"></i> Credenciales</a>
                        </li>
