...
class Empresas extends CI_Controller {
	...
	public function index(){
		...
		$datos = $this->empresas_model->getAllPagination($pagina,$porpagina,'limit');
		$cuantos = $this->empresas_model->getAllPagination($pagina,$porpagina,'cuantos');
	...
	public function add(){
		...
		if ($this->input->post()) {
			if ($this->form_validation->run('add_empresa')) {
				...
				$insertar = $this->empresas_model->insertar($data);
				$this->session->set_flashdata('css', 'success');
				$this->session->set_flashdata('mensaje', 'La Empresa se ha creado exitosamente');
	...
	public function edit($id=null,$pagina=null){
		...
		$datos=$this->empresas_model->getAllById($id);
		...
		if ($this->input->post()) {
			if ($this->form_validation->run('add_empresa')) {
				...
				$this->empresas_model->update($data,$this->input->post('id',true));
